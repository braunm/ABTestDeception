...
ui_offcanvas <- div(class= "offcanvas offcanvas-top", tabindex="-1",
...
ui_offcanvas_btn <- tags$a(class="btn btn-primary", `data-bs-toggle`="offcanvas",
                        href="#settings", role="button",
                        "Settings")



ui_header <-     div(class='position-fixed bg-light',
                  div(class='d-flex flex-nowrap',
                      ui_offcanvas,
                      div(class='me-auto', ui_offcanvas_btn),
